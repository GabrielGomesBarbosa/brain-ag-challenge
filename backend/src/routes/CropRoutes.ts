...
cropRoutes.post('/crops', (req, res) => { cropController.create(req, res) });
cropRoutes.get('/crops/:id', (req, res) => { cropController.read(req, res) });
cropRoutes.put('/crops/:id', (req, res) => { cropController.update(req, res) });
cropRoutes.delete('/crops/:id', (req, res) => { cropController.delete(req, res) });

cropRoutes.post('/crops/filter', (req, res) => {cropController.filter(req, res)});
